...
class UserRoleServiceTest {
    ...
    @Test
    void replacementDeduplicatesIdsAndReturnsStaticRolePermissions() {
        ...
        Role role = Role.builder()
                .id(first)
                .name("AUDITOR")
                .permissionNames(List.of("IGNORED_DATABASE_PERMISSION"))
                .build();
        ...
        assertThat(result.getFirst().getPermissionNames())
                .contains("STOCK_BALANCE_READ")
                .doesNotContain("IGNORED_DATABASE_PERMISSION");
        verify(guard).lock();
