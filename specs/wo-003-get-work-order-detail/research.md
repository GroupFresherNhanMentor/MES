...
- **Alternatives Considered**:
  - *jOOQ `MULTISET` join*: Combines all 3 queries into a single SQL statement. Evaluated, but separate repository calls are simpler and maintain clearer domain boundary mapping for low-cardinality detail views.
